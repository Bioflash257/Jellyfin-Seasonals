...
This plugin is based on my manual mod for testing/subpaths originally, which builds up on the awesome work of [CodeDevMLH-jellyfin-seasonals](https://github.com/CodeDevMLH/Jellyfin-Seasonals/tree).
